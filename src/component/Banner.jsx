...
const Banner = ({ bannerAPI: { title, text, btnText, imgSrc } }) => {
  return (
    <>
      <div className="relative w-full max-w-5xl ml-auto mr-auto mt-0 mb-3 xl:w-[95vh] rounded-lg ">
        ...
        <div className="absolute top-24 left-12 w-full  flex flex-col items-start md:items-center md:justify-center md:left-0 md:top-14">
          ...
          <button
            type="button"
            className="py-1.5 px-5 bg-gradient-to-b from-gray-900 to-slate-800 text-slate-300 rounded-full shadow-lg shadow-slate-900 transition-all duration-300 active:scale-110"
          >
            {btnText}
          </button>
        </div>
