...
const PriceCard = ({
  ...
  return (
    <>
      <div className="p-5 rounded-lg bg-slate-50/5 ring-1 shadow-md ring-slate-100  shadow-slate-200 hover:scale-105  duration-300 transition-all cursor-pointer">
        ...
        <div className="grid items-center gap-3 px-5">
          {plancontent?.map((val, i) => (
            <div key={i} className="flex items-center justify-start gap-5">
              ...
              <div className="grid items-center">
                <h1 className="font-normal text-gray-900 filter drop-shadow-lg text-lg lg:text-base hover:text-emerald-500">
                  {val.text}
                </h1>
              </div>
            </div>
