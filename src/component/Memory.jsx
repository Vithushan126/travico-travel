    ...
    <>
      <div className="relative my-16 md:mb-7">
        <div className="travigo-container flex items-center justify-between gap-16 xl:gap-9 lg:flex-col-reverse">
          <div className="flex items-center justify-start lg:justify-center object-fill">
            <img
              src={img}
              alt="memory/img"
          ...
          <div className=" grid items-center w-full">
            ...
            <div className="grid items-center grid-cols-3 gap-7 xl:gap-3">
              {experience?.map((val, i) => (
                <div
                  key={i}
                  className="bg-gradient-to-b from-emerald-500 to-green-300 shadow-emerald-200 flex items-center justify-center flex-col py-7 px-5 xl:p-5 rounded-lg text-slate-900 filter cursor-pointer hover:scale-105 transition-all duration-400 "
                >
